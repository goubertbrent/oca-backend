...
from rogerthat.bizz.service import publish_changes
...
from solutions.common.bizz.messaging import POKE_TAG_EVENTS, POKE_TAG_APPOINTMENT, POKE_TAG_ASK_QUESTION, \
    ...
    POKE_TAG_PHARMACY_ORDER, POKE_TAG_REPAIR, POKE_TAG_SANDWICH_BAR, POKE_TAG_WHEN_WHERE
...
REVERSE_POKE_TAG_MAPPING = {
    ...
    # ServiceMenuDef.TAG_MC_BROADCAST_SETTINGS: SolutionModule.BROADCAST,
