    ...
    $.widget('ui.panel', {
        ...
        _panelize: function() {
            if (this.element.is('div')) {
                ...
                var helpUrl = this.panelBox.attr('helpUrl');
                if (!this.options.helpUrl && helpUrl)
                ...
                if (this.options.helpUrl && this.options.helpIcon) {
                	this.titleBox.prepend($('<div></div>').css('float','right').append(
                			$('<a></a>').attr('href', this.options.helpUrl).attr('target', '_blank').append(
                					$('<img></img>').attr('src',this.options.helpIcon).css('height', '16px'))));
                }
