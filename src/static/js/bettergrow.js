...
//		});
		...
		the_object.bind('keyup', function() { 
			textarea_grow_some(the_object, min_height, settings.on_resize);
			return true;
	...
	**********************************************************************************/
	function textarea_grow_some(obj, min_height, on_resize){
//		var curr_height;
...
//			if (! textarea_grow_some.padding_calc	)
//				textarea_grow_some.padding_calc = 0;
//		}
//	 
...
//		}
//	 
//		curr_scroll_height = obj.get(0).scrollHeight - textarea_grow_some.padding_calc + 3;
//	
//		// apply the math
//		if (curr_scroll_height > min_height) {
//			obj.height(curr_scroll_height);
//			if (on_resize) on_resize(curr_scroll_height);
//		} else if (curr_height > min_height) {
//			obj.height(min_height);
//			if (on_resize) on_resize(min_height);
//		}
		...
		obj.height(0);
		var sheight = obj.get(0).scrollHeight + 2;
