...
from solutions.common.models import SolutionQR, SolutionServiceConsent, SolutionModuleAppText
...
DEFAULT_JS_TEMPLATES = [
    ...
    'settings/module_app_texts_list',
    'settings/module_app_texts_form',
...
class FlexHomeHandler(webapp2.RequestHandler):
    ...
    def get(self):
        ...
        params = {
            'stripePublicKey': solution_server_settings.stripe_public_key,
            ...
            'text_customizable_modules': json.dumps(
                [m for m in SolutionModule.TEXT_CUSTOMIZABLE if m in sln_settings.modules]),
            'custom_text_types': json.dumps(SolutionModuleAppText.ALL_TYPES),
