...
from rogerthat.bizz.elasticsearch import delete_doc_operations, create_index, get_elasticsearch_config, \
    index_doc_operations, execute_bulk_request, delete_index, es_request
...
from rogerthat.models.jobs import JobOffer, JobMatchingCriteria
