...
class HomeScreen(object):
    ...
    def __init__(self, content=None, bottom_navigation=None, bottom_sheet=None, default_language=None, translations=None, local_vars_configuration=None):  # noqa: E501
