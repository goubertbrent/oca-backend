...
import { NewsApp, NewsItemAppStatistics } from '../../../../interfaces';
...
export class TestComponent {
  ...
  newsStatistics: NewsItemAppStatistics[] | null = null;
