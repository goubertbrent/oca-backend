 ...
 * @deprecated
 */
export class SetToolbarItemsAction implements Action {
  readonly type = ToolbarActionTypes.SET_ITEMS;

  constructor(public payload: Array<ToolbarItem>) {
  }
}
