...
import { ERROR_HANDLING_TRANSLATIONS, ErrorHandlingModule, ErrorServiceTranslations, SimpleDialogModule } from '@oca/web-shared';
...
const ERROR_HANDLING_TRANLATIONS_PROVIDER: Provider = {
