...
export function participationReducer(state: ParticipationState = initialState, action: ParticipationActions): ParticipationState {
  switch (action.type) {
    ...
    case ParticipationActionTypes.GET_PROJECTS_FAILED:
      return { ...state, projects: onLoadableError(action.payload, state.projects.data) };
    ...
    case ParticipationActionTypes.GET_PROJECT_FAILED:
      return { ...state, projectDetails: onLoadableError(action.payload, state.projectDetails.data) };
    ...
    case ParticipationActionTypes.GET_PROJECT_STATISTICS_FAILED:
      return { ...state, projectStatistics: onLoadableError(action.payload, state.projectStatistics.data) };
    ...
    case ParticipationActionTypes.GET_SETTINGS_FAILED:
      return { ...state, settings: onLoadableError(action.payload, state.settings.data) };
