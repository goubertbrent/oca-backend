...
def update_home_screen(community_id, home_screen=None):  # noqa: E501
    """Saves the homescreen for a community

     # noqa: E501

    :param community_id: The id of the community to which this homescreen belongs
    ...
    get_homescreen_ref(community_id).set(home_screen.to_dict())
