...
from common.mcfw.properties import long_list_property, azzert, unicode_property,\
    long_property
from common.mcfw.serialization import ds_long, ds_unicode, s_long, s_unicode,\
    s_long_list, ds_long_list, get_list_serializer, get_list_deserializer
from common.mcfw.utils import convert_to_str
...
class NewsItemStatistics(object):
    ...
    def get_gender_index(gender):
        if gender == 1: # GENDER_MALE
            return 1
        if gender == 2: #GENDER_FEMALE
            return 2
        return 0
