...
from common.consts import MIGRATION_QUEUE
from workers.news.models import NewsSettingsUser, NewsItemMatch,\
    NewsSettingsUserService


def cleanup_news_data(app_user):
