...
class TestOpeningHours(mc_unittest.TestCase):
    ...
    def _create_hours(self, exception_color):
        ...
        opening_hours.periods = [
            ...
            OpeningPeriod(close=OpeningHour(day=0, time='1806'),  # saturday
                          open=OpeningHour(day=6, time='0600'))]
            ...
            OpeningHourException(start_date=datetime.date(2019, 12, 28),
                                 ...
                                 periods=[
                                     ...
                                     OpeningPeriod(close=OpeningHour(day=5, time='2035'),  # friday
                                                   ...
                                                   description_color=self.exception_color_hex),
                                     OpeningPeriod(close=OpeningHour(day=0, time='2006'),  # saturday
                                                   open=OpeningHour(day=6, time='0600'),
    ...
    def test_hours_1(self):
        ...
        now_open, open_until, extra_description, weekday_text = get_opening_hours_info(opening_hours, self.timezone,
                                                                                       self.lang, now)
        self.assertEqual(now_open, True)
        self.assertEqual(open_until, 'Open until 6:33 PM')
        ...
        self.assertEqual(weekday_text, [WeekDayTextTO(lines=[MapItemLineTextPartTO(text='Closed')],
                                        ...
                                        WeekDayTextTO(lines=[MapItemLineTextPartTO(text='5:00 AM - 6:35 PM')],
                                                      day='Friday'),
                                        WeekDayTextTO(lines=[MapItemLineTextPartTO(text='6:00 AM - 12:00 AM')],
                                                      day='Saturday'),
                                        WeekDayTextTO(lines=[MapItemLineTextPartTO(text='12:00 AM - 6:06 PM')],
                                                      day='Sunday')])
    ...
    def test_hours_3(self):
        ...
        now_open, open_until, extra_description, weekday_text = get_opening_hours_info(opening_hours, self.timezone,
                                                                                       self.lang, now)
        self.assertEqual(now_open, True)
        self.assertEqual(open_until, 'Open until Sunday 6:06 PM')
        self.assertEqual(extra_description, None)
        self.assertEqual(weekday_text, [WeekDayTextTO(lines=[MapItemLineTextPartTO(text='Closed')],
                                                      day='Monday'),
                                        WeekDayTextTO(lines=[MapItemLineTextPartTO(text='2:00 AM - 6:32 PM')],
    ...
    def test_hours_8(self):
        ...
        now_open, open_until, extra_description, weekday_text = get_opening_hours_info(opening_hours, self.timezone,
                                                                                       self.lang, now)
        self.assertEqual(now_open, False)
        self.assertEqual(open_until, 'Opens on Thursday at 4:00 AM')
        self.assertEqual(extra_description, '25 dec gesloten e2')
        self.assertEqual(weekday_text, [WeekDayTextTO(lines=[MapItemLineTextPartTO(text='Closed'),
                                                             MapItemLineTextPartTO(text='28 dec - 2 jan langer open e2', color=self.exception_color_hex)],
                                                      day='Monday'),
                                        WeekDayTextTO(lines=[MapItemLineTextPartTO(text='2:00 AM - 8:32 PM'),
                                                             MapItemLineTextPartTO(text='e2 tuesday', color=self.exception_color_hex)],
                                                      day='Tuesday'),
                                        WeekDayTextTO(lines=[MapItemLineTextPartTO(text='Closed'),
                                                             MapItemLineTextPartTO(text='25 dec gesloten e2', color=self.exception_color_hex)],
                                                      day='Wednesday'),
                                        WeekDayTextTO(lines=[MapItemLineTextPartTO(text='4:00 AM - 6:34 PM')],
                                                      day='Thursday'),
                                        WeekDayTextTO(lines=[MapItemLineTextPartTO(text='5:00 AM - 6:35 PM')],
                                                      day='Friday'),
                                        WeekDayTextTO(lines=[MapItemLineTextPartTO(text='6:00 AM - 12:00 AM'),
                                                             MapItemLineTextPartTO(text='e2 saturday', color=self.exception_color_hex)],
                                                      day='Saturday'),
                                        WeekDayTextTO(lines=[MapItemLineTextPartTO(text='12:00 AM - 8:06 PM'),
                                                             MapItemLineTextPartTO(text='e2 saturday', color=self.exception_color_hex)],
                                                      day='Sunday')])
    ...
    def test_hours_9(self):
        ...
        now_open, open_until, extra_description, weekday_text = get_opening_hours_info(opening_hours, self.timezone,
                                                                                       self.lang, now)
        self.assertEqual(now_open, True)
        self.assertEqual(open_until, 'Open until 6:35 PM')
        self.assertEqual(extra_description, None)
        self.assertEqual(weekday_text, [WeekDayTextTO(lines=[MapItemLineTextPartTO(text='Closed'),
                                                             MapItemLineTextPartTO(text=u'28 dec - 2 jan langer open e2', color=self.exception_color_hex)],
                                                      day='Monday'),
                                        WeekDayTextTO(lines=[MapItemLineTextPartTO(text='2:00 AM - 8:32 PM'),
                                                             MapItemLineTextPartTO(text='e2 tuesday', color=self.exception_color_hex)],
                                                      day='Tuesday'),
                                        WeekDayTextTO(lines=[MapItemLineTextPartTO(text='3:00 AM - 8:33 PM'),
                                                             MapItemLineTextPartTO(text='28 dec - 2 jan langer open e2', color=self.exception_color_hex)],
                                                      day='Wednesday'),
                                        WeekDayTextTO(lines=[MapItemLineTextPartTO(text='4:00 AM - 8:34 PM'),
                                                             MapItemLineTextPartTO(text='e2 thursday', color=self.exception_color_hex)],
                                                      day='Thursday'),
                                        WeekDayTextTO(lines=[MapItemLineTextPartTO(text='5:00 AM - 6:35 PM')],
                                                      day='Friday'),
                                        WeekDayTextTO(lines=[MapItemLineTextPartTO(text='6:00 AM - 12:00 AM'),
    ...
    def test_hours_10(self):
        ...
        now_open, open_until, extra_description, weekday_text = get_opening_hours_info(opening_hours, self.timezone,
                                                                                       self.lang, now)
        self.assertEqual(now_open, True)
        self.assertEqual(open_until, 'Open until 8:32 PM')
        self.assertEqual(extra_description, '28 dec - 2 jan langer open e2')
        self.assertEqual(weekday_text, [WeekDayTextTO(lines=[MapItemLineTextPartTO(text='Closed')],
                                                      day='Monday'),
                                        WeekDayTextTO(lines=[MapItemLineTextPartTO(text='2:00 AM - 8:32 PM'),
                                                             MapItemLineTextPartTO(text='e2 tuesday', color=self.exception_color_hex)],
                                        ...
                                        WeekDayTextTO(lines=[MapItemLineTextPartTO(text='4:00 AM - 8:34 PM'),
                                                      ...
                                                      day='Thursday'),
                                        WeekDayTextTO(lines=[MapItemLineTextPartTO(text='Closed'),
                                                             MapItemLineTextPartTO(text='3 jan gesloten e3', color=self.exception_color_hex)],
                                                      day='Friday'),
                                        WeekDayTextTO(lines=[MapItemLineTextPartTO(text='Closed'),
                                                             MapItemLineTextPartTO(text='4 jan gesloten e4', color=self.exception_color_hex)],
                                                      day='Saturday'),
                                        WeekDayTextTO(lines=[MapItemLineTextPartTO(text='Closed')],
                                                      day='Sunday')])
    ...
    def test_hours_13(self):
        ...
        self.assertEqual(weekday_text, [WeekDayTextTO(lines=[MapItemLineTextPartTO(text='8:00 AM - 8:01 AM'),
                                                             MapItemLineTextPartTO(text='exception 1 child 1', color=self.exception_color_hex),
                                                             MapItemLineTextPartTO(text='9:00 AM - 9:01 AM'),
                                                             MapItemLineTextPartTO(text='exception 1 child 2', color=self.exception_color_hex)],
                                                      day='Monday'),
                                        WeekDayTextTO(lines=[MapItemLineTextPartTO(text='Closed'),
    ...
    def test_close_day_gt_open_day(self):
        ...
        self.assertEqual(WeekDayTextTO(lines=[MapItemLineTextPartTO(color=None, text=u'5:00 PM - 12:00 AM')],
                                       day=u'Monday'), weekday_text[0])
        self.assertEqual(WeekDayTextTO(lines=[MapItemLineTextPartTO(color=None, text=u'12:00 AM - 1:00 AM')],
    ...
    def test_close_day_gt_open_day_multiple_periods(self):
        ...
        self.assertEqual(WeekDayTextTO(lines=[MapItemLineTextPartTO(color=None, text=u'5:00 PM - 12:00 AM')],
                                       day=u'Monday'), weekday_text[0])
        self.assertEqual(WeekDayTextTO(lines=[MapItemLineTextPartTO(color=None, text=u'12:00 AM - 1:00 AM'),
                                              MapItemLineTextPartTO(color=None, text=u'9:00 AM - 11:30 AM')],
                                       day=u'Tuesday'), weekday_text[1])
        self.assertEqual(True, now_open)
        self.assertEqual('Open until Tuesday 1:00 AM', open_until)
