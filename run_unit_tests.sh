...
PYTHONPATH=src-test:build::build/lib:${CUR_DIR}/../rogerthat-backend/src-test:$GAE:$GAE/lib/jinja2-2.6/:$GAE/lib/yaml/lib/:$GAE/lib/webob_0_9/:$GAE/lib/webapp2-2.5.2/:$GAE/lib/django-1.4/:$GAE/lib/jinja2-2.6/ nosetests -w src-test/test --all-modules -vv --attr=assertAlmostEqual
